 ...
 * @author aron_
 */
public class C_All_DatosPersonales extends javax.swing.JFrame {

    /**
     * Creates new form DatosPersonales
     */
    public C_All_DatosPersonales() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("MIS DATOS PERSONALES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_All_DatosPersonales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new C_All_DatosPersonales().setVisible(true);
            }
        });
    }
