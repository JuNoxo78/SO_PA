...
public class B_Profesor_MisEvaluaciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelWelcome.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        jLabelWelcome.setForeground(new java.awt.Color(0, 102, 102));
        jLabelWelcome.setText("BIENVENIDO PROFESOR,");
        ...
        jLabelName.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        jLabelName.setForeground(new java.awt.Color(0, 102, 102));
        jLabelName.setText("XXXX XXXX");
